...
data = pd.DataFrame({
    ...
    'CreditHistory': ['Good','Good','Good','Bad','Bad','Good','Good','Bad'],
    'PropertyArea': ['Urban','Rural','Urban','Urban','Rural','Semiurban','Urban','Rural'],
    'LoanAmount': [100, 80, 200, 50, 150, 70, 250, 40],
    'LoanTerm': [360, 180, 360, 120, 240, 180, 360, 120],
...
# -----------------------------
categorical_features = ['Interest', 'Extra-Curricular-Activities', 'CreditHistory', 'PropertyArea']
...
print("New customer loan prediction:", "Approved" if prediction[0]==1 else "Rejected")